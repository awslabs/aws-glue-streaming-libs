...
class DynamicFrame(object):
    ...
    def get_number_of_unprocessed_file(self):
        return self._jdf.getUnprocessedFileNum()

    def get_number_of_processed_file(self):
        return self._jdf.getProcessedFileNum()

    def get_size_of_unprocessed_file(self):
        return self._jdf.getUnprocessedFileSize()

    def get_size_of_processed_file(self):
        return self._jdf.getProcessedFileSize()
